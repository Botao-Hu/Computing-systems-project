...
typedef struct Value {
    ...
    /*!
     * This flag is used by garbage collector to determine whether this value
     * needs to be reclaimed or not. In initialization this flag will be set
     * to zero. After a traverse of memory pool, useful variables would have
     * the flag to be 0, and then garbage collector reclaims garbage with 
     * flag = 1.
     */
    int garbage_flag;
} Value;
