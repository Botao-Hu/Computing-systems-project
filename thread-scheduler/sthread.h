...
/*!
 * This function obtains the scheduler lock when called, and returns 1 if
 * the lock is granted, or 0 otherwise.
 */
int __sthread_lock(void);

/*! This function releases the scheduler lock when called. */
